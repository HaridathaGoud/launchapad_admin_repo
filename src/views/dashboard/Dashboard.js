...
import {
  ...
  CCardBody,
  CCol,
  CRow,CBreadcrumb,CBreadcrumbItem,CLink
} from '@coreui/react'
...
const Dashboard = () => {
  ...
  const getProjectDetail=async()=>{
    let res=await apiCalls.getProjectDetails("7F5EDC4B-C1C9-4FA7-8F2F-003788836275");
    
  }
  const getDashboardDetails=async()=>{
    let res=await apiCalls.getDashboardDetails(`7F5EDC4B-C1C9-4FA7-8F2F-003788836275`);
    if(res.ok){
    }
  }
