...
export default function NovotedTestDao() {

    return (
        <>
           <div className='voting-card status-section mt-4 '>
             <div className='pt-4 px-4 md-d-flex justify-content-between align-items-center'> 
             <p className='mb-0'>
                <span className='icon proposalicon me-3 '></span>
                <span className='back-text mb-0 vertical-align-middle'>Test DAO</span>
              </p>
              <div>
              <Button className='me-2 common-heading'>Change Your Vote</Button>
              ...
              <div className='d-flex status-section justify-content-center align-items-center py-3'>
               ...
               <div>
                <p className='mb-0 para-text'>Your vote was cast successfully<br/>You voted <span className='common-heading'> No</span> with <span className='common-heading'>5 YETT.</span></p>
               </div>
              </div></div>
             </div>
        </>
