...
const UserMenu = (props) => {
    ...
    if (isAdmin?.isAdmin) {
        return (
            <React.Fragment>
                {locationSplit[1]=="userprofile" && <CNavItem className={locationSplit[2] == "dashboard" ? "active" : ""}>
                    <OverlayTrigger
                        placement="right"
               ...
               {locationSplit[1] =="userprofile" && 
                ...
                {locationSplit[1] =="userprofile" &&  <CNavItem className={locationSplit[2] == "investors" ? "active" : ""}>
                    <OverlayTrigger
                        placement="right"
                ...
                {locationSplit[1] =="userprofile" && <CNavItem className={locationSplit[2] == "idorequest" ? "active" : ""}>
                    <> <OverlayTrigger
                        placement="right"
                ...
                {locationSplit[1] =="userprofile" &&  <CNavItem className={locationSplit[2] == "transactions" ? "active" : ""}>
                    <OverlayTrigger
                        placement="right"
